/*
    ...
    Website : https://projectslearner.com/learn/arduino-nano-magic-light-cup-module
*/

const int magicLightCupPin = 2; // Digital pin connected to the Magic Light Cup module
